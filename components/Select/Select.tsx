...
const Select: React.FC<ISelectProps> = ({
  ...
  return (
    <div className={`${style.select} ${className} select`}>
      ...
      <InputField type="text" className={`${style.select__input} ${isOpen && style['select__input--open']}`} placeholder={placeholder} value={defaultValue?.text ?? value?.text} onClick={() => setIsOpen(!isOpen)} />
