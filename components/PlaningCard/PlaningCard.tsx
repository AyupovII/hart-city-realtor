import { PlaningListType } from '../PlaningList/PlaningList'
import style from './PlaningCard.module.scss'
import objectImg from '../../assets/img/object.png'

const PlaningCard: React.FC<PlaningListType & { isTableType: boolean }> = ({ id, title, columnRoom, area, floor, price, isTableType }) => {
  return (
    isTableType ?
      ...
      :
      <div className={`${style["planingCard-list"]} 11`}>
